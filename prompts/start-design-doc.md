...
## Conventions- `TODO(Px-TAG)` — Open question with priority- Link everything — Questions → Proposals → Scenarios → Back to index- One question at a time in proposals — Don't bundle unrelated decision
